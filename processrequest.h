...
inline std::pair<QString, QString> repairdialog(QWidget *parent) {
    QMessageBox msgBox(parent);
    msgBox.setWindowTitle("处理请求");

    QLabel *titleLabel = new QLabel("请输入处理的维修ID:", &msgBox);
    QLineEdit *lineEdit = new QLineEdit(&msgBox);
    lineEdit->setPlaceholderText("输入维修ID...");
    lineEdit->setFocus();
